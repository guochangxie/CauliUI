...
public class CauliFilter extends Filter{
    ...
    public boolean shouldRun(Description description) {
        if(!description.getTestClass().isAnnotationPresent(org.cauli.ui.annotation.Filter.class)||
                !description.getTestClass().isAnnotationPresent(Tag.class)){
            return true;
        }else{
            String value = description.getTestClass().getAnnotation(org.cauli.ui.annotation.Filter.class).value();
