...
public class Select extends Element {
    ...
    public Select(IBrowser browser,By by){
        super(browser);
        this.select = new org.openqa.selenium.support.ui.Select(browser.getCurrentBrowserDriver().findElement(by));
    }
    ...
    public void selectByValue(String value){
        if(isExist()){
            ...
            logger.info("["+RuntimeMethod.getName()+"]"+">>["+getId()+"]选择"+value+"所在项成功！");
        }else{
